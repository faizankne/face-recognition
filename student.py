...
class Student:
    ...
    # This part is image labels setting start 
        ...
        img=img.resize((1366,110),Image.ANTIALIAS)
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Student Pannel",font=("verdana",26,"bold"),bg="white",fg="navyblue",anchor="center")
        title_lb1.place(x=0,y=0,width=1266,height=45)

        # Creating Frame 
        main_frame = Frame(bg_img,bd=2,bg="white") #bd mean border 
        main_frame.place(x=0,y=50,width=1355,height=510)

        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="navyblue")
        left_frame.place(x=0,y=6,width=650,height=480)
        ...
        dep_combo["values"]=("Select Department","UG","PG")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BA","BSC","BCA","BBA","BSW", "BCOM","MA", "MSC", "MCA", "MBA", "MCOM")
        cou_combo.current(0)
        ...
        #Student id
        studentId_label = Label(class_Student_frame,text="AUID:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Class Section:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        right_frame.place(x=660,y=5,width=650,height=480)
        ...
        #combo box 
        search_combo=ttk.Combobox(search_frame,textvariable=self.var_searchTX,width=8,font=("verdana",12,"bold"),state="readonly")
        search_combo["values"]=("Select","AUID","Reg-No")
        search_combo.current(0)
        search_combo.grid(row=0,column=1,padx=5,pady=15,sticky=W)

        self.var_search=StringVar()
        search_entry = ttk.Entry(search_frame,textvariable=self.var_search,width=8,font=("verdana",12,"bold"))
        search_entry.grid(row=0,column=2,padx=5,pady=5,sticky=W)

        search_btn=Button(search_frame,command=self.search_data,text="Search",width=8,font=("verdana",12,"bold"),fg="white",bg="navyblue")
