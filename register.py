...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\bgReg.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame= Frame(self.root,bg="#F2F2F2")
        frame.place(x=180,y=70,width=900,height=560)
        

        # img1=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\reg1.png")
        ...
        self.txtuser.place(x=103,y=160,width=270)
        ...
        self.txtuser.place(x=533,y=160,width=270)
        ...
        loginbtn.place(x=150,y=495,width=180,height=30)
        ...
        loginbtn.place(x=580,y=495,width=180,height=30)
