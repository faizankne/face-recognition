...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Attendance Pannel",font=("verdana",26,"bold"),bg="white",fg="navyblue",anchor="center")
        ...
        right_frame.place(x=653,y=6,width=650,height=480)
        ...
        table_frame.place(x=10,y=90,width=600,height=350)
