...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\bg3.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame1= Frame(self.root,bg="#002B53")
        frame1.place(x=465,y=170,width=340,height=450)

        img1=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\log1.png")
        img1=img1.resize((100,100),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1,bg="#002B53")
        lb1img1.place(x=580,y=175, width=100,height=100)
        ...
        loginbtn.place(x=35,y=370,width=50,height=60)
        ...
        loginbtn.place(x=250,y=370,width=50,height=60)
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(username='root', password='root',host='localhost',database='face_recoginition',port=3306)
...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\bg3.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Attendance Managment System Using Facial Recognition",font=("verdana",26,"bold"),bg="white",fg="navyblue", anchor="center")
        title_lb1.place(x=0,y=0,width=1266,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\std1.jpg")
        std_img_btn=std_img_btn.resize((160,160),Image.ANTIALIAS)
        self.std_img1=ImageTk.PhotoImage(std_img_btn)

        std_b1 = Button(bg_img,command=self.student_pannels,image=self.std_img1,cursor="hand2")
        std_b1.place(x=250,y=90,width=159,height=160)

        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Student Pannel",cursor="hand2",font=("tahoma",12,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=250,width=160,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\det1.jpg")
        det_img_btn=det_img_btn.resize((160,160),Image.ANTIALIAS)
        self.det_img1=ImageTk.PhotoImage(det_img_btn)

        det_b1 = Button(bg_img,command=self.face_rec,image=self.det_img1,cursor="hand2",)
        det_b1.place(x=480,y=90,width=159,height=160)

        det_b1_1 = Button(bg_img,command=self.face_rec,text="Face Detector",cursor="hand2",font=("tahoma",12,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=250,width=160,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\att.jpg")
        att_img_btn=att_img_btn.resize((160,160),Image.ANTIALIAS)
        self.att_img1=ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img,command=self.attendance_pannel,image=self.att_img1,cursor="hand2",)
        att_b1.place(x=710,y=90,width=159,height=160)
        ...
        att_b1_1.place(x=710,y=250,width=160,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\hlp.jpg")
        hlp_img_btn=hlp_img_btn.resize((160,160),Image.ANTIALIAS)
        self.hlp_img1=ImageTk.PhotoImage(hlp_img_btn)

        hlp_b1 = Button(bg_img,image=self.hlp_img1,cursor="hand2",)
        hlp_b1.place(x=940,y=90,width=159,height=160)

        hlp_b1_1 = Button(bg_img,text="Help Support",cursor="hand2",font=("tahoma",12,"bold"),bg="white",fg="navyblue")
        hlp_b1_1.place(x=940,y=250,width=160,height=45)

        # Top 4 buttons end.......
        # ---------------------------------------------------------------------------------------------------------------------------
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\tra1.jpg")
        tra_img_btn=tra_img_btn.resize((160,160),Image.ANTIALIAS)
        self.tra_img1=ImageTk.PhotoImage(tra_img_btn)

        tra_b1 = Button(bg_img,command=self.train_pannels,image=self.tra_img1,cursor="hand2",)
        tra_b1.place(x=250,y=330,width=159,height=160)

        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Data Train",cursor="hand2",font=("tahoma",12,"bold"),bg="white",fg="navyblue")
        tra_b1_1.place(x=250,y=490,width=160,height=45)

        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\qr1.png")
        pho_img_btn=pho_img_btn.resize((160,160),Image.ANTIALIAS)
        self.pho_img1=ImageTk.PhotoImage(pho_img_btn)

        pho_b1 = Button(bg_img,command=self.open_img,image=self.pho_img1,cursor="hand2",)
        pho_b1.place(x=480,y=330,width=159,height=160)

        pho_b1_1 = Button(bg_img,command=self.open_img,text="QR-Codes",cursor="hand2",font=("tahoma",12,"bold"),bg="white",fg="navyblue")
        pho_b1_1.place(x=480,y=490,width=160,height=45)

        # Developers   button 7
        dev_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\dev.jpg")
        dev_img_btn=dev_img_btn.resize((160,160),Image.ANTIALIAS)
        self.dev_img1=ImageTk.PhotoImage(dev_img_btn)

        dev_b1 = Button(bg_img,command=self.developr,image=self.dev_img1,cursor="hand2",)
        dev_b1.place(x=710,y=330,width=159,height=160)

        dev_b1_1 = Button(bg_img,command=self.developr,text="Developers",cursor="hand2",font=("tahoma",12,"bold"),bg="white",fg="navyblue")
        dev_b1_1.place(x=710,y=490,width=160,height=45)

        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\faizankne\Documents\python_test-projects\Images_GUI\exi.jpg")
        exi_img_btn=exi_img_btn.resize((160,160),Image.ANTIALIAS)
        self.exi_img1=ImageTk.PhotoImage(exi_img_btn)

        exi_b1 = Button(bg_img,image=self.exi_img1,cursor="hand2",)
        exi_b1.place(x=940,y=330,width=159,height=160)

        exi_b1_1 = Button(bg_img,text="Exit",cursor="hand2",font=("tahoma",12,"bold"),bg="white",fg="navyblue")
        exi_b1_1.place(x=940,y=490,width=160,height=45)
